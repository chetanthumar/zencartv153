...
// javascript messages
  ...
  define('PREVNEXT_BUTTON_FIRST', '<img src="'.$template->get_template_dir("",DIR_WS_TEMPLATE, $current_page_base,"images").'/prev-product.png"'.'/>&nbsp;&nbsp;FIRST');
  define('PREVNEXT_BUTTON_PREV', '<img src="'.$template->get_template_dir("",DIR_WS_TEMPLATE, $current_page_base,"images").'/prev-product.png"'.'/>&nbsp;&nbsp;Prev');
  define('PREVNEXT_BUTTON_NEXT', 'Next&nbsp;&nbsp;<img src="'.$template->get_template_dir("",DIR_WS_TEMPLATE, $current_page_base,"images").'/next-product.png"'.'/>');
